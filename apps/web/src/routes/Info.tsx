...
const SEARCH_INDEX: readonly SearchEntry[] = [
  ...
  { tab: "about", title: "System status — operational ping",
    body: "Curated public 'don't trust, verify' strip: build hash, 5 verified contracts link, on-chain / Chainlink Automation statement, real /v1/health Operational ping, last-update date. Veracity-guarded: never a false green, never exposes LINK / queue / secret internals.",
    ...
    <section className="space-y-6">
      ...
      <div className="card">
        ...
        <ul className="space-y-2 text-sm text-text-on-dark/90 list-disc list-inside">
          ...
          <li><strong>Source verification</strong> on PolygonScan for all 5 — anyone (including you, right now) can read the deployed code independently. The bytecode on-chain provably matches the source.</li>
        </ul>
      </div>
      ...
      <div className="card">
        ...
        <ul className="space-y-2 text-sm text-text-on-dark/90 list-disc list-inside">
          ...
          <li><strong>The attack surface is tiny.</strong> Five small contracts; no external integrations beyond USDC's standard ERC-20 and Chainlink Automation's standard interface. Most formal-audit value comes from complex DeFi composition we deliberately don't have.</li>
      ...
      <div id="bug-bounty" className="card border-accent-green/50">
        ...
        <ul className="list-disc list-inside space-y-1 text-sm text-text-on-dark/90">
          <li>The five deployed contracts (License, SBT, Oracle, Recovery, Escrow) on Polygon mainnet.</li>
